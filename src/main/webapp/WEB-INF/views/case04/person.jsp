...
<body style="padding: 15px">
	...
	<spform:form class="pure-form" 
		...
		<fieldset>
			...
			<button type="button" class="pure-button pure-button-primary" ${_method=='POST'?'':disabled}>新增</button>
			<button type="button" class="pure-button pure-button-primary" ${_method=='PUT'?'':disabled}>修改</button>
			<p />
			<spform:errors path="*" cssClass="error"></spform:errors>
		</fieldset>
	</spform:form>
	<table class="pure-form pure-table-bordered">
		<thead>
			<tr>index</tr>
			<tr>person</tr>
